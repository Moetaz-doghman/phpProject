  ...
  if (isset($_GET['id'])) {
      $reponseId = $_GET['id'];
      $reponse = $reponseC->getReponseById($reponseId);
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <form action="" method="post">
              ...
              <input type="hidden" name="reponse_id" value="<?php echo $reponse->getId(); ?>">

              <div class="card-body">
                <div class="form-group">
                  <label for="responseContent">Response Content</label>
                  <textarea class="form-control" id="responseContent" name="responseContent"><?php echo $reponse->getContenu(); ?></textarea>
                </div>
              </div>
              <!-- /.card-body -->
